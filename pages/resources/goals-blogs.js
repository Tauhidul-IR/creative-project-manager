            ...
            <div className='grid justify-center items-center'>
                <div className='mx-14 my-4 gap-4'>
                    <div className="card lg:card-side  bg-base-100 shadow-xl">
                        <figure><img className='w-96 h-96' src="https://assets.asana.biz/transform/5895eaa5-578e-4068-aeb6-c1bc36c0d7dc/article-goals-goals-2x?io=transform:fill,width:375&format=webp" alt="Album" /></figure>
                ...
                <div className='grid gap-5 my-2 mx-1  grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                    {
                        goalsBlog?.map(goalsBlog => <div key={goalsBlog?._id}>
                            ...
                            <div className="card w-96   bg-base-100 shadow-xl">
                                <figure><img className='w-96 h-52' src={goalsBlog?.picture} alt="Album" /></figure>
